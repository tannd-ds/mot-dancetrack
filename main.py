...
def parse_args():
    ...
    parser.add_argument('--network', choices=['unet', 'transformer', 'fc', 'autoencoder', 'cnn', 'huy_cnn'], help='Unet version')
    parser.add_argument('--num_classifiers', type=int, default = 1, help='Number of classifiers')
    parser.add_argument('--loss', type=str, choices=['l1', 'l2'], help='Loss function')
